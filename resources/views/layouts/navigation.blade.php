    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('ativo')" :active="request()->routeIs('ativo')">
                        {{ __('Criar um ativo') }}
                    </x-nav-link>
                </div>
            ...
            <div class="px-4">
                    ...
                    <div class="">
                        <x-dropdown  align="left" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center  py-4 border border-transparent text-base leading-2 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">

...
3. Problemas com o vite:
   ...
   Feito isso, se a pagina desenvolvida com o Vite nao puxarr o CSS implementado abra dois terminais distintos no VS Code através do comando CRTL + ' no primeiro terminal execute:
